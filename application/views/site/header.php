...
<div class="top-bar">
    <div class="container">
        <ul class="kt-nav top-bar-menu">
            <li><a href="#"><span class="menu-icon pe-7s-headphones"></span>0938206613</a></li>
            <li><a href="https://mail.google.com"><span class="menu-icon flaticon-new4"></span> yokechan2911@gmail.com</a></li>
        </ul>
    ...
    <div class="main-header">
        <div class="row main-header-wapper">
            <div class="col-sm-12 col-md-3">
                <div class="logo">
                    <a href="#"><img src="<?php echo base_url('upload'); ?>/logos/logo.png" alt="" style="height: 12%"></a>
                </div>
            </div>
