        ...
        <div class="verticalmenu-content">
            ...
            <?php foreach ($catalog_list as $row): ?>
                <li class="menu-item-has-children">
                    <a href="<?php echo base_url('san-pham/danh-muc/'.seoname($row->name).'/'.$row->id_catalog); ?>"><span class="menu-icon"><img src="<?php echo base_url('upload'); ?>/icons/12.png" alt=""></span><?php echo $row->name; ?></a>
                </li>
            <?php endforeach; ?>
            </ul>
