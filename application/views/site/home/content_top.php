                    ...
                    <li class="product-item style9" style="float: left; width: 28%;">
                        <div class="product-inner">
                            ...
                            <div class="info col-sm-7">
                                <h3 class="product-name short"><a title="<?php echo $row->site_title; ?>" href="<?php echo base_url('chi-tiet-san-pham/'.seoname($row->name_catalog).'/'.seoname($row->name).'/'.$row->id_product) ?>"><?php echo $row->name; ?></a>
                                </h3>
